...
public class DebugRenderer {
    ...
    public void drawAngleVector(Transform transform, float angleRad) {
        drawLine(new Vector2(transform.x, transform.y), new Vector2(transform.x + 5*MathUtils.cos(angleRad), transform.y + 5*MathUtils.sin(angleRad)));
    }


    public void drawVelVector(Transform transform) {
        drawLine(new Vector2(transform.x, transform.y), new Vector2(transform.x + transform.xVel, transform.y + transform.yVel));
    }
    ...
    public void drawRectangle(Rectangle r) {
        ...
        drawLine(new Vector2(r.x, r.y), new Vector2(r.x+r.width, r.y+r.height));
    }
