...
public class ParticleOLD extends InanimateEntity {
    public ParticleTypesOLD parameters;
    ...
    ParticleOLD(ParticleTypesOLD parameters, Color startColor, Color endColor, float size, float angle, float startingSpeed) {
        super(0, 0);
