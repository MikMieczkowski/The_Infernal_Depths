...
public class SpawnProbabilityConstants {
    ...
    public static final SpawnProbability NORMAL_CHANCE = new SpawnProbability(92, 76.69f, 54.5f, 27.5f);
    ...
    public static final SpawnProbability INFERNAL_CHANCE = new SpawnProbability(0, .01f, .5f, 30);
